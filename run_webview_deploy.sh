...
xvfb-run --server-args="-screen 0 1920x1080x24" /workspace/build/tests/cefclient/Release/cefclient --off-screen-rendering-enabled --url=http://25.2.19.24:3000/websiteview --no-sandbox &
...
while true; do
  ...
  curl -X POST -F "file=@./img.png" http://25.2.19.24:8080/image/upload
